...
// WhatsApp SVG inline — avoids loading entire react-icons/fa package (~430KB wasted JS)
const WhatsAppIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="h-8 w-8 transition-transform group-hover:rotate-12" aria-hidden="true">
